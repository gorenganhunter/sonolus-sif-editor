...
<template>
    <circle :cx="0" :cy="0" :r="0.5" class="scale-stroke" stroke-width="0.05" stroke="#fff" />
    
    <text :x="0" :y="0" v-if="isStar" text-anchor="middle" dominant-baseline="middle" fill="#ffff5555" font-size="1">☆</text>
